...
public class DataInitializer {
    ...
    public CommandLineRunner initData(UserRepository userRepository,
        ...
        return args -> {
            ...
            // DATA INTEGRITY FIX: Mrs. Raziya Sultana missing department
            userRepository.findAll().stream()
                    .filter(u -> u.getFullName() != null && u.getFullName().toLowerCase().contains("raziya"))
                    .filter(u -> u.getDepartment() == null || u.getDepartment().isBlank())
                    .findFirst()
                    .ifPresent(u -> {
                        u.setDepartment("EEE");
                        userRepository.save(u);
                        System.out.println("✅ Data Integrity Fix: Assigned 'EEE' department to " + u.getFullName());
                    });
